import { BarChart, Calculator, Leaf, Lightbulb } from "lucide-react";
        ...
        <div className="lg:col-span-2 flex flex-col justify-center">
          <div className="text-center lg:text-left">
            ...
            <div className="bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-xl p-4 mb-4">
              <h2 className="text-xl md:text-2xl font-bold text-green-100 mb-3 drop-shadow">
                What We Do
              </h2>
              ...
              return (
                ...
                >
                  <div className="flex items-center mb-2">
                    ...
                    <h3 className={`text-lg font-bold drop-shadow ${feature.titleColor}`}>
                      {feature.title}
                    </h3>
                  </div>
