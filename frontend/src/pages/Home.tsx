...
const HomePage = () => {
  return (
    <div className="text-center max-w-4xl">
      <h1 className="text-6xl font-bold text-white mb-4 drop-shadow-lg">EcoViz</h1>
      ...
      <div className="bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-xl p-8 mb-8">
        <h2 className="text-3xl font-bold text-green-100 mb-4 drop-shadow">What We Do</h2>
        <p className="text-xl  mb-6 font-medium">
          EcoViz is a powerful tool that helps you understand and minimize your environmental impact:
        </p>
        <ul className="text-left text-lg text-white space-y-4 font-medium">
          <li className="flex items-center">
            <Calculator className="mr-2 text-green-300" /> <span>Calculate your personal carbon footprint</span>
          </li>
          <li className="flex items-center">
            <BarChart className="mr-2 text-blue-500" />{' '}
            <span>Visualize your impact across different areas of your life</span>
          </li>
          <li className="flex items-center">
            <Lightbulb className="mr-2 text-yellow-400" />{' '}
            <span>Get AI-powered recommendations to reduce your carbon footprint</span>
          </li>
        </ul>
      </div>
      <Link
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <div key={index} className="bg-white bg-opacity-25 backdrop-filter backdrop-blur-lg rounded-xl p-6 shadow-lg">
            <h2 className={`text-2xl font-bold mb-2 drop-shadow ${feature.titleColor}`}>{feature.title}</h2>
