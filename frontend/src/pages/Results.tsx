...
const Results: React.FC = () => {
  ...
  const calculateSectorEmissions = () => {
    ...
    const transportation =
      (calculationData.transportation.car.milesDriven / calculationData.transportation.car.fuelEfficiency) * 8.89 +
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 text-center">
            <p className="text-lg">
              ...
              <strong className="text-green-700">{((carbonFootprint / averages.us - 1) * 100).toFixed(1)}%</strong>{' '}
