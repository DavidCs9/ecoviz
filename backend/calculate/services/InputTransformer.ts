import { UserInput, CalculationData } from '../types'
import { EnergyRates, VehicleData, InputMappings } from '../config'
...
export class InputTransformer {
   ...
   */
  private async transformTransportationData(transportation: NonNullable<UserInput['transportation']>) {
    ...
    const annualTrainMiles = (publicTransit.weeklyTrainMiles || 0) * VehicleData.WORK_WEEKS_PER_YEAR
